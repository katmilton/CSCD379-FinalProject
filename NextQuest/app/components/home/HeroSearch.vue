...
.hero-heading { max-width: 760px; line-height: 0.98; letter-spacing: -0.03em; }
.hero-subcopy { max-width: 700px; }
.hero-metrics { display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 26px; }
.hero-search-card { position: relative; z-index: 1; padding: 22px; }
